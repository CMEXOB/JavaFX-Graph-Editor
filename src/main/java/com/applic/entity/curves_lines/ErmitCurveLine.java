...
public class ErmitCurveLine extends CurveLine {

    public ErmitCurveLine(){
        super(4);
        matrix.set(0,0,2);
        matrix.set(0,1,-2);
        matrix.set(0,2,1);
    ...
    public void createDrawPoints() {
        ...
        inputPointsMatrix.set(1,0, inputPoints.get(2).getX());
        inputPointsMatrix.set(1,1, inputPoints.get(2).getY());

        inputPointsMatrix.set(2,0, inputPoints.get(1).getX());
        inputPointsMatrix.set(2,1, inputPoints.get(1).getY());
